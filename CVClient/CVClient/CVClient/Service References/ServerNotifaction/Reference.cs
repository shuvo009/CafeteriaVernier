...
namespace Procesta.CVClient.ServerNotifaction {
    ...
    public partial class CounterInformation : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private Procesta.CVClient.ServerNotifaction.CounterStatus StatusField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public Procesta.CVClient.ServerNotifaction.CounterStatus Status {
            get {
    ...
    public interface IServerNotification {
        ...
        void SetCounterInformation(Procesta.CVClient.ServerNotifaction.CounterInformation counterInfo);
        ...
        System.Collections.Generic.List<Procesta.CVClient.ServerNotifaction.CounterInformation> GetCounterInformation();
        ...
        void RemoveCounterInformation(Procesta.CVClient.ServerNotifaction.CounterInformation counterInfo);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServerNotificationChannel : Procesta.CVClient.ServerNotifaction.IServerNotification, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServerNotificationClient : System.ServiceModel.ClientBase<Procesta.CVClient.ServerNotifaction.IServerNotification>, Procesta.CVClient.ServerNotifaction.IServerNotification {
        ...
        public void SetCounterInformation(Procesta.CVClient.ServerNotifaction.CounterInformation counterInfo) {
            base.Channel.SetCounterInformation(counterInfo);
        }
        
        public System.Collections.Generic.List<Procesta.CVClient.ServerNotifaction.CounterInformation> GetCounterInformation() {
            return base.Channel.GetCounterInformation();
        }
        
        public void RemoveCounterInformation(Procesta.CVClient.ServerNotifaction.CounterInformation counterInfo) {
